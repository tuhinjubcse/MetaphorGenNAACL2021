...
class SequenceGenerator(object):
    def __init__(
        ...
        self.coefs = coefs
        self.learn = False #learn
        self.learn_every_token = False #learn_every_token # controls granularity of token learning
        # **************************

        assert temperature > 0, '--temperature must be greater than 0'
        #print("Search strategy is",search_strategy)
        self.search = (
    ...
    def generate(self, models, sample, **kwargs):
        ...
        Args:
            ...
            bos_token (int, optional): beginning of sentence token
                (default: self.eos)
        """
        #print("KWARGS IN SEQ GEN",kwargs)
